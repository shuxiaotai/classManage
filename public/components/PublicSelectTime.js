    ...
    return (
      <View style={styles.homePageTopItem}>
        <TouchableOpacity
          ...
          <View
            style={{position: 'absolute', right: arrowRight ? arrowRight : 50}}>
            <Icon
          ...
          style={
            showSelectTime
              ? [
                  ...
                  {top: top ? top : 34, height: height ? height : 200},
                ]
              : styles.selectHiddenContainer
          }>
          {data.map(item => {
            return (
              <TouchableOpacity
                ...
                <Text
                  style={{
                    color: selectTimeKey === item.id ? '#0f7cda' : 'black',
                  }}>
                  {item.name}
                </Text>
              </TouchableOpacity>
