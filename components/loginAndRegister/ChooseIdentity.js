  ...
  render() {
    ...
    return (
      <View>
        <View
          style={
            showAutoLoginTips ? styles.loadContainer : styles.hiddenAutoLogin
          }>
          <Button
            title=""
            loading
        ...
        <View style={styles.chooseIdentity}>
          <Text style={styles.topText}>选择身份</Text>
          <Text style={styles.tipsText}>身份一旦选择后无法更改</Text>
          <View style={styles.chooseContainer}>
            ...
            <TouchableOpacity onPress={() => this.changeSelectIdentity(1)}>
              <Image
        ...
        <PublicBtn tips="下一步" onPress={this.gotoNextStep} />
      </View>
    );
  }
}
