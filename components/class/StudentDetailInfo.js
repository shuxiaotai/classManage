...
class StudentDetailInfo extends Component {
  ...
  render() {
    ...
    return (
      <View>
        <PublicHeader title="学生资料" isLeft={true} navigation={navigation} />
        ...
        <PublicBtn tips="从班级中删除" onPress={this.removeStudentInClass} />
      </View>
    );
  }
}
