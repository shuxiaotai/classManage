...
class RemarkModalContent extends Component {
  ...
  getCriticizeTemplateList = () => {
    ...
    checkUser(() => {
      fetchData
        .postData('/criticizeTemplateList', {
          currentClassId: currentClassId,
        })
        .then(val => {
            ...
            return (
              <TouchableOpacity
                ...
                <View
                  style={
                    isPraise
                      ? styles.scorePraiseView
                      : styles.scoreCriticizeView
                  }>
                  <Text style={styles.scoreText}>
                    {isPraise ? `+${item.score}` : `-${item.score}`}
                  </Text>
                </View>
                <Image
