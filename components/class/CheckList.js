...
class CheckList extends Component {
  ...
  saveCheckRecord = () => {
    AlertIOS.prompt('Alert', '给这次考勤起个名字吧', [
      {
        text: '取消',
  ...
  render() {
    ...
    return (
      <View>
        ...
        />
        {isDetail ? null : newStudentList.length === 0 ? null : (
          <PublicBtn tips="保存考勤记录" onPress={this.saveCheckRecord} />
        )}
      </View>
    );
  }
