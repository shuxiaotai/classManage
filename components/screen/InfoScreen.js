...
class InfoScreen extends Component {
  ...
  static getDerivedStateFromProps(preProps, preState) {
    if (
      ...
      preState.isFresh !== preProps.navigation.state.params.isFresh
    ) {
      return {
            ...
            teacherId === item.teacher_id ? (
              <TouchableOpacity
                ...
                <Icon
                  ...
                  size={20}
                />
                {currentInfoId === item.info_id &&
                currentSelectClassId === item.class_id ? (
                  <View
                    style={!showDeleteBtn ? styles.hidden : styles.manageInfo}>
      ...
      <View style={styles.main}>
        ...
        (selectKey === 1 || selectKey === 2 || selectKey === 3) ? (
          <TouchableOpacity
            ...
            <Icon name="edit" color="#00aced" size={25} />
          </TouchableOpacity>
        ) : null}
      </View>
    );
